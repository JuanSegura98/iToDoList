...
// Usando esta clase se guardan las tareas en la base de datos local con SQLite
public class TasksDatabaseRepository {

    private final TasksDatabase admin;
    FirebaseFirestore db = FirebaseFirestore.getInstance();

    public TasksDatabaseRepository(Context context) {
